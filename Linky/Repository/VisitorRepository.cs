...
namespace Linky.Repository
{
    public class VisitorRepository : IVisitorRepository
    {
        ...
        // NOTE: EF Core 10 CompileAsyncQuery with terminal operators (.ToList(), .Count(), etc.)
        // returns Func<TContext, …, Task<T>> WITHOUT CancellationToken — that is the correct type.
